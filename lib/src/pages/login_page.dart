...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget _showErrorBanner(){
    TextStyle errStyle = TextStyle(fontWeight: FontWeight.bold, color: Colors.white);
  ...
  void _login(LoginBloc bloc, BuildContext context) async {
    ...
    Map result = await _usermanagement.login(bloc.username, bloc.password, bloc.account);
